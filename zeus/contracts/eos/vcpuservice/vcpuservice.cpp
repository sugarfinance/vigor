#define SVC_NAME vcpu
#include "../dappservices/vcpu.hpp"
CONTRACT vcpuservice : public eosio::contract {
...
#ifdef VCPU_DAPPSERVICE_SERVICE_MORE
  VCPU_DAPPSERVICE_SERVICE_MORE
#endif
...
EOSIO_DISPATCH_SVC_PROVIDER(vcpuservice)
