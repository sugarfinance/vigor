...
cleos wallet create --to-console
cleos wallet unlock -n default --password PW5KSBDPFjLF4Hsy3z7KzShszyuSo3NMFBpinqsPgvxBwwe9zFw2w
cleos wallet import -n default --private-key $OWNER_ACCT
cleos wallet list
...
cleos set contract eosio.wrap /home/ik/contracts/eosio.contracts/contracts/eosio.wrap/
...
CONTRACT_INCLUDE_BOOST=/home/ik/contracts/vigor/contracts/vigor/include/boost
CONTRACT="vigor"
