...
nodeos -e -p eosio --http-validate-host=false --delete-all-blocks
 --plugin eosio::chain_api_plugin --contracts-console --plugin eosio::http_plugin 
 --plugin eosio::history_api_plugin --verbose-http-errors --max-transaction-time=10000
...
OWNER_ACCT="5J3TQGkkiRQBKcg8ik2a7Kk5a2QAQXsyGrkCnnq4krSSJSUkW12"
...
# nodeosurl='http://127.0.0.1:8888' interval=15000 account="oracleoracle" defaultPrivateKey="5J3TQGkkiRQBKcg8ik2a7Kk5a2QAQXsyGrkCnnq4krSSJSUkW12" feeder="feeder111111" node updater2.js
