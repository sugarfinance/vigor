...
CONTRACT vigortester1 : public eosio::contract {
   ...
   private:
      ...
      map <symbol, name> issueracct {
         ...
         {symbol("VIG",4),	    name("vigtokenz111")},
      ...
      }; typedef eosio::multi_index< name("coinstat"), currency_stats > coinstats;
   ...
   public:
      ...
      vigortester1(name receiver, name code, datastream<const char*> ds):contract(receiver, code, ds), 
